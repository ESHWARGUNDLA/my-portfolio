...
const Contact = () =>{
    ...
    emailjs.sendForm('service_05rtj6w','YOUR_SERVICE_ID', 'template_l8msamp', formRef.current, 'FZVO0E7iaoKkq1nlb')
      .then((result) => {
          setSuccess(true)
      }, (error) => {
        setError(true)
    ...
    return (
        <motion.div ref={ref} className="contact" variants={variants} initial="initial" whileInView="animate">
            ...
            <motion.h1>Lets works together</motion.h1>
            <motion.div className="item" variants={variants}>
            <h3>Mail</h3>
            <span>eshwargundla2001@gmail.com</span>
            </motion.div>
            <motion.div className="item" variants={variants}>
            <h3>Address</h3>
